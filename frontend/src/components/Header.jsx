  ...
  return (
    <header className="header">
      <a href="/" className="logo-link">
        <div className="logo">CROWNLINE&nbsp; AUTOMOTIVE</div>
      </a>
        ...
        >
          ...
          {brandsOpen && (
            <div className="dropdown-content brands">
              ...
              <a href="/vehicles/brand/Honda" className="dropdown-link">Honda</a>
              ...
              <a href="/vehicles/brand/Lexus" className="dropdown-link">Lexus</a>
              <a href="/vehicles/brand/Volkswagen" className="dropdown-link">Volkswagen</a>
              <a href="/vehicles/brand/Volvo" className="dropdown-link">Volvo</a>
              <a href="/vehicles/brand/Genesis" className="dropdown-link">Genesis</a>
              <a href="/vehicles/brand/INFINITI" className="dropdown-link">INFINITI</a>
            </div>
          )}
        </div>
